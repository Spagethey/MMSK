...
def run():
	...
	data = random._urandom(666)	while True:
		...
		try:
			...
			print(" 0xF1 Dika %s Kontol %s"%(ip,port))
...
def tcp():
	...
	while True:
		...
		try:
			...
			print("\033[1;31;40m 0xF1 Dika %s Kontol %s"%(ip,port))
